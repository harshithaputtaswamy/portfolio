const projectData = [
    { 
        ...
        description: "Creating a Reinforcement Learning (RL) environment, utilizing Multi-Arm Bandits setup, \
        to train agents on scoring based and condercet voting rules, optimizing the evaluation of these rules.",
        link: '',
